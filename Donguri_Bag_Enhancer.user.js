  ...
  */
  ...
  function initAll(){
    ...
    #dbe-W-Backup { --dbe-backup-row-gap: 24px; }
      ...
      /* === ▽ここから▽ 既存フィルタカード一覧 用 === */
      .saved-filter-card{ padding:6px 8px; border:1px solid #ccc; border-radius:8px; background:#fff; margin:6px 0; }
    ...
    function renderCards(kind){
      ...
      list.forEach((card, idx)=>{
        ...
        Object.assign(row.style, {
          ...
          alignItems:'start',
          gap:'8px',
          border:'1px solid #CCC', borderRadius:'6px', padding:'6px', background:'#FFF'
        });
        // 整形HTMLを取得
        let html = '';
        try{
